...
import DyslexiaAssessment from './pages/dyslexia-assessment';
    ...
    <ErrorBoundary>
      ...
      <RouterRoutes>
        ...
        <Route path="/resource-center" element={<ResourceCenter />} />
         <Route path="/dyslexia-assessment" element={<DyslexiaAssessment />} />
...
//<Route path="/multi-role-dashboard" element={<ProtectedRoute allowedRoles={["student"]}></ProtectedRoute>} />
//<Route path="/multi-role-dashboard" element={<ProtectedRoute allowedRoles={["teacher"]}></ProtectedRoute>} />
